    ...
    public class CarController : MonoBehaviour
{
    ...
    public float speedModifier = 3.6f;
    ...
    public float brakeStregh = 300.0f; // Maximum reverse speed in km/h
    public float reverseStregh = 600.0f; // Maximum reverse speed in km/h
    ...
    void Move()
    {
        ...
        float speed = carRb.velocity.magnitude * speedModifier; // Convert m/s to km/h
        ...
        for (int i = 0; i < wheels.Count; i++)
        {
            ...
            if (isReversing)
            {
                ...
                {
                    wheels[i].wheelCollider.motorTorque = -moveInput * reverseStregh * maxAcceleration * Time.deltaTime;
                }
                else
                {
    ...
    void Brake()
    {
        if (isBraking)
        {
            for (int i = 0; i < wheels.Count; i++)
            {
                wheels[i].wheelCollider.brakeTorque = brakeStregh * brakeAcceleration * Time.deltaTime;
            }
